...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        com.daxslab.mail.mail.Address[] addresses =  com.daxslab.mail.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        com.daxslab.mail.mail.Address[] addresses =  com.daxslab.mail.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.daxslab.mail.mail.Address[] addresses =  com.daxslab.mail.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
