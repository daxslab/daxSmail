package com.daxslab.mail.remotecontrol;
...
public class K9RemoteControl {
     ...
     */
    public final static String K9_REMOTE_CONTROL_PERMISSION = "com.daxslab.mail.permission.REMOTE_CONTROL";
    /**
     ...
     */
    public final static String K9_REQUEST_ACCOUNTS = "com.daxslab.mail.K9RemoteControl.requestAccounts";
    public final static String K9_ACCOUNT_UUIDS = "com.daxslab.mail.K9RemoteControl.accountUuids";
    public final static String K9_ACCOUNT_DESCRIPTIONS = "com.daxslab.mail.K9RemoteControl.accountDescriptions";

    /**
     * The {@link {@link Intent}} Action to set in order to cause K-9 to check mail.  (Not yet implemented)
     */
    //public final static String K9_CHECK_MAIL = "com.daxslab.mail.K9RemoteControl.checkMail";

    /**
     * The {@link {@link Intent}} Action to set when remotely changing K-9 Mail settings
     */
    public final static String K9_SET = "com.daxslab.mail.K9RemoteControl.set";
    /**
     ...
     * is absent or false.
     */
    public final static String K9_ACCOUNT_UUID = "com.daxslab.mail.K9RemoteControl.accountUuid";
    /**
     ...
     */
    public final static String K9_ALL_ACCOUNTS = "com.daxslab.mail.K9RemoteControl.allAccounts";
     ...
     */
    public final static String K9_NOTIFICATION_ENABLED = "com.daxslab.mail.K9RemoteControl.notificationEnabled";
    /*
     * Key for the {@link Intent} Extra for controlling whether K-9 will sound the ringtone for new unread mail.
     * Acceptable values are K9_ENABLED and K9_DISABLED
     */
    public final static String K9_RING_ENABLED = "com.daxslab.mail.K9RemoteControl.ringEnabled";
    /*
     * Key for the {@link Intent} Extra for controlling whether K-9 will activate the vibrator for new unread mail.
     * Acceptable values are K9_ENABLED and K9_DISABLED
     */
    public final static String K9_VIBRATE_ENABLED = "com.daxslab.mail.K9RemoteControl.vibrateEnabled";
     ...
     */
    public final static String K9_PUSH_CLASSES = "com.daxslab.mail.K9RemoteControl.pushClasses";
    /**
     * Key for the {@link Intent} Extra to set for controlling which folders to be synchronized with Poll.
     * Acceptable values are K9_FOLDERS_ALL, K9_FOLDERS_FIRST_CLASS, K9_FOLDERS_FIRST_AND_SECOND_CLASS,
     * K9_FOLDERS_NOT_SECOND_CLASS, K9_FOLDERS_NONE
     */
    public final static String K9_POLL_CLASSES = "com.daxslab.mail.K9RemoteControl.pollClasses";
     ...
     */
    public final static String K9_POLL_FREQUENCY = "com.daxslab.mail.K9RemoteControl.pollFrequency";
     ...
     */
    public final static String K9_BACKGROUND_OPERATIONS = "com.daxslab.mail.K9RemoteControl.backgroundOperations";
     ...
     */
    public final static String K9_THEME = "com.daxslab.mail.K9RemoteControl.theme";
