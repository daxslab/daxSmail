...
import com.daxslab.mail.Account.SortType;
import com.daxslab.mail.activity.MessageCompose;
import com.daxslab.mail.activity.UpgradeDatabases;
...
import com.daxslab.mail.provider.UnreadWidgetProvider;
import com.daxslab.mail.security.LocalKeyStore;
import com.daxslab.mail.service.BootReceiver;
import com.daxslab.mail.service.MailService;
import com.daxslab.mail.service.ShutdownReceiver;
import com.daxslab.mail.service.StorageGoneReceiver;
...
public class K9 extends Application {
    ...
    public static final String LOG_TAG = "com.daxslab.mail";
     ...
     * was called.
     * Afterwards calls to {@link #registerApplicationAware(com.daxslab.mail.K9.ApplicationAware)} will
     * immediately call {@link com.daxslab.mail.K9.ApplicationAware#initializeComponent(K9)} for the
     * supplied argument.
     */
    ...
    public static class Intents {
        ...
        public static class EmailReceived {
            public static final String ACTION_EMAIL_RECEIVED    = "com.daxslab.mail.intent.action.EMAIL_RECEIVED";
            public static final String ACTION_EMAIL_DELETED     = "com.daxslab.mail.intent.action.EMAIL_DELETED";
            public static final String ACTION_REFRESH_OBSERVER  = "com.daxslab.mail.intent.action.REFRESH_OBSERVER";
            public static final String EXTRA_ACCOUNT            = "com.daxslab.mail.intent.extra.ACCOUNT";
            public static final String EXTRA_FOLDER             = "com.daxslab.mail.intent.extra.FOLDER";
            public static final String EXTRA_SENT_DATE          = "com.daxslab.mail.intent.extra.SENT_DATE";
            public static final String EXTRA_FROM               = "com.daxslab.mail.intent.extra.FROM";
            public static final String EXTRA_TO                 = "com.daxslab.mail.intent.extra.TO";
            public static final String EXTRA_CC                 = "com.daxslab.mail.intent.extra.CC";
            public static final String EXTRA_BCC                = "com.daxslab.mail.intent.extra.BCC";
            public static final String EXTRA_SUBJECT            = "com.daxslab.mail.intent.extra.SUBJECT";
            public static final String EXTRA_FROM_SELF          = "com.daxslab.mail.intent.extra.FROM_SELF";
        }

        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.daxslab.mail.intent.extra.FROM")
             * because of different semantics (String array vs. string with comma separated
             * email addresses)
             */
            public static final String EXTRA_FROM               = "com.daxslab.mail.intent.extra.SENDER";
        }
    }
