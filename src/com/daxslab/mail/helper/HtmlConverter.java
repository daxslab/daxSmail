...
public class HtmlConverter {
    ...
    /**
     * Convert an HTML string to a plain text string.
     * including a image getter
     * @param html HTML string to convert.
     * @return Plain text result.
     */
    public static String htmlToText(final String html, Html.ImageGetter imageGetter) {
        return Html.fromHtml(html, imageGetter, new HtmlToTextTagHandler()).toString()
                .replace(PREVIEW_OBJECT_CHARACTER, PREVIEW_OBJECT_REPLACEMENT)
                .replace(NBSP_CHARACTER, NBSP_REPLACEMENT);
    }
     ...
     * {@link com.daxslab.mail.view#MessageWebView.setText(String) MessageWebView.setText()}
     * </p>
     *
     * @param text
     *         Plain text string.
     ...
     * @return A {@link Spanned} containing the text in {@code html} formatted using spans.
     */
    public static Spanned htmlToSpanned(String html, Html.ImageGetter imageGetter) {
        return Html.fromHtml(html, imageGetter, new ListTagHandler());
    }
