...
public class MailService extends CoreService {
    private static final String ACTION_CHECK_MAIL = "com.daxslab.mail.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESET = "com.daxslab.mail.intent.action.MAIL_SERVICE_RESET";
    private static final String ACTION_RESCHEDULE_POLL = "com.daxslab.mail.intent.action.MAIL_SERVICE_RESCHEDULE_POLL";
    private static final String ACTION_CANCEL = "com.daxslab.mail.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_REFRESH_PUSHERS = "com.daxslab.mail.intent.action.MAIL_SERVICE_REFRESH_PUSHERS";
    private static final String ACTION_RESTART_PUSHERS = "com.daxslab.mail.intent.action.MAIL_SERVICE_RESTART_PUSHERS";
    private static final String CONNECTIVITY_CHANGE = "com.daxslab.mail.intent.action.MAIL_SERVICE_CONNECTIVITY_CHANGE";
    private static final String CANCEL_CONNECTIVITY_NOTICE = "com.daxslab.mail.intent.action.MAIL_SERVICE_CANCEL_CONNECTIVITY_NOTICE";
    ...
    private void cancel() {
        Intent i = new Intent();
        i.setClassName(getApplication().getPackageName(), "com.daxslab.mail.service.MailService");
