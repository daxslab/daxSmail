...
import com.daxslab.mail.mail.filter.CountingOutputStream;
...
public abstract class Message implements Part, CompositeBody {
     ...
     * {@link com.daxslab.mail.activity.MessageView.Listener#loadMessageForViewHeadersAvailable(com.daxslab.mail.Account, String, String, Message)}
